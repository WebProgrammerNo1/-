    ...
    <>
        ...
        <AboutWrapper>
            <div className="containers">
                <div className="about">
                    <h1 className='my-3'>Про нас</h1>
                    <div className="sliderBlock">
                        <img src={image} alt="" />
                    </div>
                    <ul className="paragrf">
                        <li>
                        ...
                        <li>
                            <h2>Дальше — больше</h2>
                            <p>Наша цель, чтобы у наших клиентов никогда не возникал вопрос «где купить мебель?». МЕГА ДОМ - самый большой интернет-магазин мебели, в котором каждый найдет свой вариант мебели. Мы хотим помочь как можно большему количеству людей стать счастливыми обладателями комфортной мебели.Ждем вас!</p>
                        </li>
                    </ul>
